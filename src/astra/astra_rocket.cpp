...
#include <vector>
#include "../../include/astra/astra_rocket.h"
...
//  HAL::delay(100);
  ...
  rootPage->addItem(new astra::Tile("测试2", pic_1));
...
//  rootPage->addItem(secondPage);
  ...
  secondPage->addItem(new astra::List("-测试2"), new astra::CheckBox(test1));
  secondPage->addItem(new astra::List("-测试测试3"), new astra::CheckBox(test2));
  secondPage->addItem(new astra::List("-测试测试测试4"), new astra::PopUp(1, "测试", {"测试"}, testIndex));
  secondPage->addItem(new astra::List("-测试测试测试5"), new astra::Slider("测试", 0, 100, 50, testSlider));
