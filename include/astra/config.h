...
struct config {
  ...
  const unsigned char *logoTitleFont = u8g2_font_wqy16_t_gb2312;
  const unsigned char *logoCopyRightFont = u8g2_font_wqy12_t_gb2312;
