...
#include <array>
#include <vector>
#include "../../include/astra/config.h"
...
public:
  ...
  static void drawCircle(float _x0, float _y0, float _r, uint8_t _opt = 0) { get()->_drawCircle(_x0, _y0, _r); }

  virtual void _drawCircle(float _x0, float _y0, float _r) {}

  static void drawDisc(float _x0, float _y0, float _r, uint8_t _opt = 0) { get()->_drawDisc(_x0, _y0, _r); }

  virtual void _drawDisc(float _x0, float _y0, float _r) {}
